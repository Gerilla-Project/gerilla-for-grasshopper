...
Public Class ZoneSurface
    ...
    Protected Overrides Sub RegisterOutputParams(ByVal pManager As Grasshopper.Kernel.GH_Component.GH_OutputParamManager)
		...
		'pManager.Register_PathParam("Path","P","Path")
    End Sub
	...
	Protected Overrides Sub SolveInstance(ByVal DA As Grasshopper.Kernel.IGH_DataAccess)
		...
		Dim outPath As New list(Of Data.GH_Path)
		For i As Integer=0 To wallPathList.Count-1
			...
			For j As Integer=0 To insurfaces.PathCount-1
				...
				'outPath.Add(selectWallPath)	
				'outPath.Add(selectWallIndex)
