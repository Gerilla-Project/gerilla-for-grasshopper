    ...
    Protected Overrides Sub SolveInstance(ByVal DA As Grasshopper.Kernel.IGH_DataAccess)
		...
		If myProjectDatabase = True Then
			...
			If System.IO.File.Exists(GerillaProjectSetup.PublicProjectFilePath & "\" & GerillaProjectSetup.PublicProjectName & "\Assemblies\" & myName & ".txt") = True Then
				...
				Select Case (ProjectDatabaseMessageBox = MsgBox("This Assembly already exists in the Project Library. Do you want to overwrite?",vbYesNo,"Save Material"))
				Case vbYes
					...
					Next
				ObjectWriter.Close()
				MsgBox("Assembly Updated")
				Case vbNo
					MsgBox("Assembly NOT Saved")
				End Select 
		...
		If myGerillaDatabase = True Then
			...
			If System.IO.File.Exists(GerillaAssemblyLibraryPath & myName & ".txt") = True Then
				...
				Select Case (GerillaDatabaseMessageBox = MsgBox("This Assembly already exists in the Gerilla Library. Do you want to overwrite?",vbYesNo,"Save Material"))
					...
					Case vbYes
						...
						MsgBox("Assembly Updated in Gerilla Library")
